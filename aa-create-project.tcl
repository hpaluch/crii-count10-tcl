# 
# Project automation script for crii-count10_work 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source /home/ise/projects/crii-count10-tcl/crii-count10_work.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "${myPrefix}crii-pins.ucf" -view "Implementation"
   xfile add "${myPrefix}top.v" -view "Implementation"
   xfile add "${myPrefix}uptime.v" -view "All"
   xfile add "${myPrefix}uptime_tf.v" -view "Simulation"
...
proc set_process_props {} {
   ...
   project set "Project Description" "Up 4-digit Decimal counter for Digilent CoolRunner II board. Uses flexible uptime.v module."
